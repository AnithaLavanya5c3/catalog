...
# Create dummy user
User1 = User(name="Anitha Lavanya", email="anithalavanya6@gmail.com",
             picture='https://cdn0.iconfinder.com/data'
             '/icons/avatars-6/500/'
             'Avatar_boy_man_people_account_boss_client_beard'
             '_male_person_user-512.png')
session.add(User1)
session.commit()
...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     description="A famous duck dish from Beijing[1] that has"
                     "been prepared since the imperial era. The meat is prized"
                     "for its thin, crisp skin, with authentic versions of the"
                     "dish serving mostly the skin and little meat, sliced in"
...
menuItem1 = MenuItem(user_id=1, name="Pho",
                     ...
                     "broth, linguine-shaped rice noodles called banh pho,"
...
menuItem9 = MenuItem(user_id=1, name="Chicken Fried Steak",
                     ...
                     "smothered with cream gravy", price="$8.99",
                     course="Entree", restaurant=restaurant1)
...
menuItem3 = MenuItem(user_id=1, name="Morels on toast (seasonal)",
                     ...
                     "served on herbed toast slices", price="$7.50",
                     course="Appetizer", restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken",
                     ...
                     "with a spicy mix(chilli, tamarind among others) and"
...
menuItem10 = MenuItem(user_id=1, name="Spinach Ice Cream",
                      description="vanilla ice cream made with organic spinach"
                      "leaves", price="$1.99",
...
menuItem1 = MenuItem(user_id=1, name="Super Burrito Al Pastor",
                     ...
                     " Cilantro, Salsa, Tortilla", price="$5.95",
                     course="Entree", restaurant=restaurant1)
...
menuItem2 = MenuItem(user_id=1, name="Cachapa",
                     ...
                     "pancake; usually stuffed with queso telita or queso"
                     "de mano, and possibly lechon. ",
                     price="$7.99", course="Entree", restaurant=restaurant1)
